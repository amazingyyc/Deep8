...
inline Eigen::Map<Eigen::Matrix<T, Eigen::Dynamic, 1>> eVec(Tensor<T> &t) {
    return Eigen::Map<Eigen::Matrix<T, Eigen::Dynamic, 1>>(static_cast<T*>(t.raw()), t.size());
}

template <typename T>
inline Eigen::Map<Eigen::Matrix<T, Eigen::Dynamic, 1>> eVec(const Tensor<T> &t) {
    return Eigen::Map<Eigen::Matrix<T, Eigen::Dynamic, 1>>(static_cast<T*>(t.raw()), t.shape.size());
}
...
inline Eigen::Map<Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>> eMat(Tensor<T> &t) {
    ...
    return Eigen::Map<Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>>(static_cast<T*>(t.raw()), t.row(), t.col());
}
...
inline Eigen::Map<Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>> eBatchMat(Tensor<T> &t, size_t b) {
    ...
    return Eigen::Map<Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>>(static_cast<T*>(t.raw()) + (b % t.batch()) * t.batchSize(), t.row(), t.col());
}
...
inline Eigen::Map<Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>> eRowBatchMat(Tensor<T> &t) {
    ...
    return Eigen::Map<Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>>(static_cast<T*>(t.raw()), t.batch() * t.row(), t.col());
}
...
inline Eigen::Map<Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>> eBatchSizeMat(Tensor<T> &t) {
    ...
    return Eigen::Map<Eigen::Matrix<T, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>>(static_cast<T*>(t.raw()), t.batch(), t.batchSize());
}
...
inline Eigen::TensorMap<Eigen::Tensor<T, 1, Eigen::RowMajor>> eTVec(Tensor<T> &t) {
    return Eigen::TensorMap<Eigen::Tensor<T, 1, Eigen::RowMajor>>(static_cast<T*>(t.raw()), t.size());
}
...
inline Eigen::TensorMap<Eigen::Tensor<T, 0, Eigen::RowMajor>> eTScalar(Tensor<T> &t) {
    ...
    return Eigen::TensorMap<Eigen::Tensor<T, 0, Eigen::RowMajor>>(static_cast<T*>(t.raw()));
}
